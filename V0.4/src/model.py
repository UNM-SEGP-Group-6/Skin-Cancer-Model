...
class MultimodalSkinCancerModel(nn.Module):
    ...
    V0.4: 3-class clinical model (benign / malignant / uncertain) trained on
    MRA-MIDAS + PAD-UFES-20 smartphone images with PH2 as external holdout.
    ...
    Parameters:
        num_classes (int): Number of output classes. Default: 3 (benign, malignant, uncertain).
